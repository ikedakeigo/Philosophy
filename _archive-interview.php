    ...
    >があります。
	  ...
	  <div class="cntBnrWrp">
	  	<ul>
			<li>
				<dl>
					<dt><a href="/about/"><img src="<?php echo get_template_directory_uri(); ?>/img/top/img_bnr_01.jpg" alt="私の哲学について" ></a></dt>
				  <dd><a href="https://myphilosophy.global/about/">私の哲学について</a></dd>
				</dl>
			</li>
			<li>
				<dl>
	  ...
	  <div class="cntIntBg">
	  	<div class="cntIntWrp">
			...
			<ul>
				<li>
					<dl>
						<dt><a href="https://myphilosophy.global/interview/leslie_k/"><img src="https://myphilosophy.global/wp-content/uploads/2024/08/img_112_main.jpg" alt="vol.112" ></a></dt>
						<dd>レスリー・キー氏は、シンガポール生まれの写真家で、東京とニューヨークを拠点に世界中で活躍しています。貧しい家庭環境から出発した彼は、逆境さえも活力に変え、独自の視点でアート、ファッション、広告の美を探求しています。彼の情熱は写真を通じて社会に貢献し続ける原動力となっており、その作品は多くの人々に勇気と希望を与えています。<a href="https://myphilosophy.global/interview/leslie_k/">READ</a></dd>
					</dl>
				</li>
				<li>
					<dl>
						<dt><a href="https://myphilosophy.global/interview/takada_m/"><img src="https://myphilosophy.global/wp-content/uploads/2024/08/img_111_main.jpg" alt="vol.111" ></a></dt>
						<dd>三菱商事の執行役員、顧問から在アルバニア大使へ転身。そして今、アルバニアと日本の企業をつなぐべく奮闘する高田光進氏。三菱商事時代のビッグビジネスから一転、スモールビジネスを一つ一つ丁寧に育てていこうと、種をまいています。夢が溢れる66歳のチャレンジを語っていただきました。<a href="https://myphilosophy.global/interview/takada_m/">READ</a></dd>
					</dl>
				</li>
				<li>
					<dl>
						<dt><a href="https://myphilosophy.global/interview/sato_k/"><img src="https://myphilosophy.global/wp-content/uploads/2024/06/img_110_main.jpg" alt="vol.110" ></a></dt>
						<dd>18歳で板前修業に入った佐藤 弘治。きっかけは、当時人気を博したテレビドラマ「前略おふくろ様」（日本テレビ系）だったという。そこから17年を経て、シャイな板前に憧れた青年は、赤坂で故郷の食材と味にこだわる割烹を開く。<a href="https://myphilosophy.global/interview/sato_k/">READ</a></dd>
					</dl>
				</li>
