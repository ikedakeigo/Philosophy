...
<div id="container">
  <div id="content">
    <div class="presents">
      <a href="/en/">
        <img src="<?php echo get_template_directory_uri(); ?>/img/philosophy/new_philosophy/logo_philosophy_presents.png" alt='Presented by "My Philosophy®︎"'>
      </a>
    </div>
    <div class="detailMain">
      <div class="taC logo pc">
        <a class="scroll" href="/en/">
          <img src="<?php echo get_template_directory_uri(); ?>/img/philosophy/new_philosophy/detail_main_title_en.png" alt="My Philosophy®︎ | Interview and Dialogue Series">
        </a>
      </div>
      <div class="taC logo sp">
        <a class="scroll" href="/en/">
          <img src="<?php echo get_template_directory_uri(); ?>/img/philosophy/new_philosophy/detail_main_title_sp_en.png" alt="My Philosophy®︎ | Interview and Dialogue Series">
        </a>
      </div>
    </div>
    <div class="container">
        ...
        <div id="main-inner">
          <div class="lead">
            ...
            <div class="LangBtn">
              ...
              <a href="<?php the_field('link_jp'); ?>">Japoneze</a>
				<?php endif; ?>
				<?php if( get_field('link_en') ): ?>
				<a href="<?php the_field('link_en'); ?>">Anglisht</a>
				<?php endif; ?>
            </div>
          
          <div class="cB"></div>
          <div class="profile">
            <h3 class="widget-title mT0">Profili</h3>
            <?php $volume = get_field('interview_vol') ? get_field('interview_vol') : get_post_number('interview'); ?>
            <p class="large"><strong>Vëll.<span id="js-number"><?php echo $volume; ?></span> <?php the_field('name'); ?></strong></p>
            <p>
